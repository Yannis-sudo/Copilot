...
export default function UITypingIndicator({ darkMode = false }: UITypingIndicatorProps): React.ReactElement {
    return (
        <div className="flex items-center gap-1.5 px-4 py-3 rounded-2xl rounded-bl-sm w-fit shadow-sm mb-4 border border-[rgba(124,58,237,0.25)] bg-[rgba(124,58,237,0.08)]">
            {[0, 1, 2].map((i) => (
                <span
                    key={i}
