            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                <div 
                    ...
                    style={{
                        ...
                        boxShadow: `0 0 48px ${theme.colors.shadow}`
                    }}
                >
                        ...
                        {availableFolders.length > 0 && (
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-4 py-2 rounded-lg border text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 ${darkMode ? "text-white" : "text-gray-800"}`}
                                    style={{
                                        backgroundColor: theme.colors.alpha08,
