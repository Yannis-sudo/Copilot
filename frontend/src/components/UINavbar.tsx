...
export default function UINavbar({
  ...
  return (
    <nav className={darkMode ? "bg-dark text-white" : "bg-gray-900 text-white"}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="relative flex h-16 items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={`transition-colors ${
                    link.active
                      ? "text-white font-semibold border-b-2 border-primary-500"
          ...
          <button
            ...
            className="ml-auto md:ml-0 p-2 rounded-lg hover:bg-gray-800 transition-colors"
